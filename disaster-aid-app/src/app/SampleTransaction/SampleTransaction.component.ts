...
export class SampleTransactionComponent implements OnInit {
  ...
  fromaccnt = new FormControl('', Validators.required);
  toaccnt = new FormControl('', Validators.required);
  ...
  constructor(private serviceSampleTransaction: SampleTransactionService, fb: FormBuilder) {
    this.myForm = fb.group({
      fromaccnt: this.fromaccnt,
      toaccnt: this.toaccnt,
      amount: this.amount,
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.ibm.disaster.fund.SampleTransaction',
      'fromaccnt': this.fromaccnt.value,
      'toaccnt': this.toaccnt.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.fromaccnt) {
        formObject.fromaccnt = result.fromaccnt;
      } else {
        formObject.fromaccnt = null;
      }

      if (result.toaccnt) {
        formObject.toaccnt = result.toaccnt;
      } else {
        formObject.toaccnt = null;
      }
